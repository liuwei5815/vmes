...
public class PageTag extends TagSupport {
	...
	public int doEndTag() throws JspTagException {
		try {
			...
			out.append("<div class='float_left padding5'>查询结果：共<label id=\"totalCountLable\">0</label>条记录 当前<label id=\"currPageLable\">0</label>/<label id=\"totalPageLable\">0</label> 页。</div> \r\n");
			...
			out.append("</div>\r\n");
			out.append("<div class='float_left padding_top3' style='padding-top: 4px;'><select autoWidth='true' id='changerow' style='height: 24px;' onchange=\"changePerPageRows();\"><option value='10'>10</option><option value='30'>30</option><option value='50'>50</option><option value='100'>100</option><option value='150'>150</option></select></div>\r\n");
			out.append("<div class='float_left padding_top6'>条记录&nbsp;&nbsp;</div>\r\n");
			out.append("<div class='float_left padding_top3' style='padding-top:5px;'><input style='width:40px;height: 17px;' name='goTo' id='goTo'/></div>\r\n");
