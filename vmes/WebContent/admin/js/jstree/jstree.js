...
/*jshint -W083 */
	...
	$.jstree.core.prototype = {
		 ...
		 * 向下移动节点
		 */
		move_down:function(currNode){
			var nextNode = this.get_next_dom(currNode,true);//返回兄弟节点的下一个节点
			this.move_node(currNode,nextNode,'after');
		},
		
		/**
		 * 向上移动节点
		 */
		move_up:function(currNode){
			var prevNode = this.get_prev_dom(currNode,true);
			this.move_node(currNode,prevNode,'before');
