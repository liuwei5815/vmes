...
$(function() {
    if (window.navigator.userAgent.indexOf("MSIE") >= 1) {
        var l = window.navigator.userAgent.substring(30, 33);
        if (l == "6.0") {
            broswerFlag = "IE6"
        } else {
            if (l == "7.0") {
    ...
    if ($(".box1").length > 0) {
        $(".box1").each(function() {
            ...
            if ($(this).attr("whiteBg") == "true") {
                ...
                var t = $(this).attr("panelWidth");
                var s = t.substr(t.length - 1, 1);
                if (s == "%") {
                    $(this).width(t)
                } else {
                    var u = Number($(this).attr("panelWidth"));
                    $(this).width(u)
                }
            }
            if ($(this).attr("panelHeight") != null) {
                ...
                var r = Number($(this).attr("panelHeight")) - $(this).find(".box1_topcenter").outerHeight() - $(this).find(".box1_bottomcenter").outerHeight();
                $(this).find(".boxContent").height(r)
            }
    ...
    if ($(".box2").length > 0) {
        $(".box2").each(function() {
            ...
            var y = $("<div class='box2_bottomcenter' id='box2_bottomcenter'><div class='box2_bottomleft'><div class='box2_bottomright'></div></div></div>");
            var x = $("<div class='box2_bottomcenter2' id='box2_bottomcenter'><div class='box2_bottomleft2'><div class='box2_bottomright2'></div></div></div>");
            ...
            if ($(this).attr("panelWidth") != null) {
                var r = $(this).attr("panelWidth");
                var A = r.substr(r.length - 1, 1);
                if (A == "%") {
                    $(this).width(r)
                } else {
            ...
            if ($(this).attr("panelHeight") != null) {
                var B = Number($(this).attr("panelHeight")) - $(this).find(".box2_topcenter").outerHeight() - $(this).find("#box2_bottomcenter").outerHeight();
                $(this).find(".boxContent").height(B)
            }
            $(this).find(".boxContent").html(t);
            if ($(this).attr("overflow") != null) {
                $(this).find(".boxContent").css({
                    overflow: $(this).attr("overflow")
                })
            ...
            if ($(this).attr("panelTarget") != null) {
                w = $(this).attr("panelTarget")
            }
            var s = "收缩";
            if ($(this).attr("statusText") != null) {
                s = $(this).attr("statusText")
            }
            var C;
            if (s == "收缩" && u == "true") {
                $(this).find(".ss").text(s);
                $(this).find(".ss").toggle(function() {
                    var D = $(this).parents(".box2").find(".boxContent");
                    C = D.height();
                    if (broswerFlag == "IE6") {
                        D.fadeOut(300, resetHeight)
                    } else {
                ...
                if (s == "展开" && u == "true") {
                    ...
                    $(this).find(".ss").toggle(function() {
                        ...
                        if (broswerFlag == "IE6") {
                            v.fadeOut(300, resetHeight)
                        } else {
                            v.hide(300, resetHeight)
                        }
                        $(this).text("展开")
                    })
                } else {
                    if (u == "true" || $(this).attr("statusText") != null) {
                        $(this).find(".ss").find("a").attr("href", z);
                        $(this).find(".ss").find("a").attr("target", w);
                        $(this).find(".ss").find("a").text(s)
                    } else {
                        $(this).find(".ss").hide()
                    }
                }
    ...
    if ($(".box3").length > 0) {
        $(".box3").each(function() {
            ...
            var x = $("<div class='box3_bottomcenter'><div class='box3_bottomleft'><div class='box3_bottomright'></div></div></div>");
            x.appendTo($(this));
            if ($(this).attr("panelTitle") != null) {
                $(this).find(".title").append($(this).attr("panelTitle"))
            }
            ...
            if ($(this).attr("panelHeight") != null) {
                ...
                var A = Number($(this).attr("panelHeight")) - $(this).find(".box3_topcenter").outerHeight() - $(this).find(".box3_bottomcenter").outerHeight();
                $(this).find(".boxContent").height(A)
            }
            $(this).find(".boxContent").html(t);
            if ($(this).attr("overflow") != null) {
                $(this).find(".boxContent").css({
            ...
            if (s == "收缩") {
                $(this).find(".ss").text(s);
                $(this).find(".ss").toggle(function() {
                    var C = $(this).parents(".box3").find(".boxContent");
                    B = C.height();
                    C.hide(300, resetHeight);
                ...
                if (s == "展开") {
                    ...
                    if (u == "true" || $(this).attr("statusText") != null) {
                        $(this).find(".ss").find("a").attr("href", y);
                        $(this).find(".ss").find("a").attr("target", w);
                        $(this).find(".ss").find("a").text(s)
                    } else {
                        $(this).find(".ss").hide()
    ...
    if ($(".box4").length > 0) {
        $(".box4").each(function() {
            ...
            if ($(this).attr("panelHeight") != null) {
                ...
                var r = Number($(this).attr("panelHeight")) - $(this).find(".box4_topcenter").outerHeight() - $(this).find(".box4_bottomcenter").outerHeight();
                $(this).find(".boxContent").height(r)
            }
            $(this).find(".boxContent").html(e);
            if ($(this).attr("overflow") != null) {
    ...
    if ($("#vtabConIn").length > 0) {
        exitVtab = 1;
        try {
            var h = jQuery.jCookie("vtabIndex");
            if (h != false) {
                vtabIdx = parseInt(h)
            }
    ...
    if ($(".date").length > 0) {
        ...
        p.src = prePath + "js/form/datePicker/WdatePicker.js";
    ...
    if ($(".cusTab").length > 0) {
        $(".cusTab").each(function() {
            ...
            if ($(this).attr("iframeMode") != "true") {
                $(this).find(".cusTab_normal_center").each(function(r) {
                    $(this).addClass("hand");
                    $(this).click(function() {
                        ...
                        $(this).parents(".cusTab").find(".cusTab_con").eq(r).fadeIn()
                    })
                })
            } else {
                $(this).find(".cusTab_normal_center a").each(function(r) {
                    $(this).addClass("hand");
                    $(this).click(function() {
    ...
    if ($("#scrollContent").length > 0) {
        ...
        if ($("body").attr("rel") == "layout") {
            ...
            try {
                window.top.document.getElementsByTagName("iframe")["frmright"].style.height = n - parentTopHeight - parentBottomHeight + "px";
            ...
            if ($("#winScrollContent").length > 0) {
                ...
                if ($("table[class=tableStyle]").length > 1) {
                    i = $("table[class=tableStyle]").eq(0);
                    if (i.attr("headFixMode") == "true" || i.attr("headFixMode") == true) {
                        b.css({
                            borderTop: 0
                        });
                        i.addClass("noBottomLine");
                        setTimeout(function() {
                            if ($("#winScrollContent")[0].scrollHeight > $("#winScrollContent")[0].clientHeight) {
                                var r = $("table:[class=tableStyle noBottomLine]").find("th").last();
                                var e = r.width();
...
function scrollContent() {
    try {
        ...
        if (parentTopHeight > 0) {
            ...
            parentBottomHeight = ($(window.parent.document.getElementById("fbox")).outerHeight()|0) + ($(window.parent.document.getElementById("rbox_bottomcenter")).outerHeight()|0);
...
function winScrollContent(c) {
    ...
    a.fn.extend({
        rebrushfileupload: function(d) {
            d = a.extend({}, rebrushfileupload.defaults, d);
