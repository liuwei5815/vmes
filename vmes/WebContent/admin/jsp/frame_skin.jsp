...
<link href="${ctx}/admin/frame/skins/<%=CacheFun.getConfig("frame_skinname")%>/import_skin.css" rel="stylesheet" type="text/css" id="skin" themeColor="<%=CacheFun.getConfig("frame_themecolor")%>" prePath="${ctx}/admin/frame/"/>
<!--框架必需end-->
<script type="text/javascript" src="${ctx}/admin/frame/js/pic/jomino.js"></script>
<script>
$(function(){
	loadMsg();
...
function showPreview(str){
	top.Dialog.open({InnerHtml:"<div style=\"text-align:center;\"><img  width='900' height='544' src='${ctx}/admin/frame/pages/main_preview/"+str+"'/></div>",Title:"皮肤预览",Width:920,Height:550});
}
function changeSkin(str1,str2){
	showProgressBar();
	document.getElementById("sessionSkin").src="${ctx}/admin/login!chgFrameSkin.action?skinName="+str1+"&themeColor="+str2;
}
...
<body>
	...
	<div class="framegrid nocaption" style="display:none;">
		<div class="picItem3"><img src="${ctx}/admin/frame/images/main_preview/sky_accordtion_small.jpg"/></div>	
	...
	<div class="framegrid nocaption" style="display:none;">
		<div class="picItem3"><img src="${ctx}/admin/frame/images/main_preview/orange_accordtion_small.jpg"/></div>	
		<div class="framegrid_cover">
	...
	<div class="framegrid nocaption" style="display:none;">
		<div class="picItem3"><img src="${ctx}/admin/frame/images/main_preview/darkBlue_accordtion_small.jpg"/></div>	
		<div class="framegrid_cover">
	...
	<div class="framegrid nocaption" style="display:none;">
		<div class="picItem3"><img src="${ctx}/admin/frame/images/main_preview/vistaBlue_accordtion_small.jpg"/></div>	
		<div class="framegrid_cover">
	...
	<div class="framegrid nocaption" style="display:none;">
		<div class="picItem3"><img src="${ctx}/admin/frame/images/main_preview/grass_accordtion_small.jpg"/></div>	
		<div class="framegrid_cover">
	...
	<div class="framegrid nocaption" style="display:none;">
		<div class="picItem3"><img src="${ctx}/admin/frame/images/main_preview/chinaRed_accordtion_small.jpg"/></div>	
		<div class="framegrid_cover">
	...
	<div class="framegrid nocaption" style="display:none;">
		<div class="picItem3"><img src="${ctx}/admin/frame/images/main_preview/armyYellow_accordtion_small.jpg"/></div>	
		<div class="framegrid_cover">
	...
	<div class="framegrid nocaption" style="display:none;">
		<div class="picItem3"><img src="${ctx}/admin/frame/images/main_preview/darkCrystal_accordtion_small.jpg"/></div>	
		<div class="framegrid_cover">
	...
	<div class="framegrid nocaption" style="display:none;">
		<div class="picItem3"><img src="${ctx}/admin/frame/images/main_preview/lightBlue_accordtion_small.jpg"/></div>	
		<div class="framegrid_cover">
	...
	<div class="framegrid nocaption" style="display:none;">
		<div class="picItem3"><img src="${ctx}/admin/frame/images/main_preview/skyAgain_accordtion_small.jpg"/></div>	
		<div class="framegrid_cover">
	...
	<div class="framegrid nocaption" style="display:none;">
		<div class="picItem3"><img src="${ctx}/admin/frame/images/main_preview/skyThird_accordtion_small.jpg"/></div>	
		<div class="framegrid_cover">
