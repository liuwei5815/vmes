...
<div style="padding: 0 20px 0 20px;">
	<s:form action="admin/product!add.action" method="post" theme="simple" id="frm">
	...
	<tr class="validate">
		<td>产品名称：</td>
		<td>
			<input type="text" name="product.name"  class="validate[required,length[0,15]]"/>
	...
	<tr class="validate">
		<td>规格/型号：</td>
		<td>
			<input type="text" name="product.typespec" class="validate[required,length[0,15]]"/>
			<span class="star"> *</span>
		</td>
	</tr>
	<!-- <tr class="validate">
		<td>产品分类：</td>
		<td>
			<input type="text" name="product.type"  class="validate[required]"/>
			<span class="star"> *</span>
		</td>
	</tr> -->
	<!--<tr  style="border: medium none; background-color: transparent;" yzid="2">
		<td style="text-align: right; padding-top: 3px; padding-bottom: 3px; border: medium none;">货品类型：</td>
			<td style="padding-top: 3px; padding-bottom: 3px; border: medium none;">
				...
				<input id="type" targetid="84" name="product.type" value="" not-null="1" lable="物料类型" datatype="1" type="hidden"></div>
