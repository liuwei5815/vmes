...
function openAddWin(){
	...
	diag.Title = "添加";
	diag.URL = "${ctx}/admin/test!preAdd.action";
	diag.Width=1200;
	diag.Height=900;
...
<body>
    ...
    <s:form method="post" target="querytable" action="admin/test!list.action"  id="frm">
...
<pt:page action="${ctx}/admin/test!list.action" target="querytable"></pt:page>
</body>
</html>
