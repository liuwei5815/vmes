...
<div style="">
	...
	<s:form action="admin/testlw!edit.action" method="post" theme="simple" id="frm">
	<input type="hidden" name="test_lw.id" id="id" value="${test_lw.id}" />
	<input type="hidden" name="test_lw.cdate" id="cdate" value="${test_lw.cdate}" />
	<input type="hidden" name="test_lw.state" id="state" value="${test_lw.state}" />
	<table width="100%" class="tableStyle" transmode="true">
			<tr class="validate">
				<td>编码：</td>
				<td>
					<input type="text" id="number" name="test_lw.number" value="${test_lw.number }" />
				</td>
			</tr>
			<tr class="validate">
				<td>名称：</td>
				<td>
					<input type="text" id="name" name="test_lw.name" value="${test_lw.name }" />
				</td>
			</tr>
		<tr>
			<td colspan="2">&nbsp;</td>
