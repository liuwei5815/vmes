...
function openAddWin(){
	...
	diag.Title = "添加";
	diag.URL = "${ctx}/admin/testlw!preAdd.action";
	diag.Width=1200;
	diag.Height=900;
...
<body>
    ...
    <s:form method="post" target="querytable" action="admin/testlw!list.action"  id="frm">
...
<div id="scrollContent">
	<iframe scrolling="no" width="100%"  frameBorder=0 id="querytable" name="querytable" src="${ctx}/admin/testlw!list.action" onload="iframeHeight('querytable')"  allowTransparency="true"></iframe>
</div>
<pt:page action="${ctx}/admin/testlw!list.action" target="querytable"></pt:page>
</body>
</html>
