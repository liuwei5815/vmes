...
<s:form name="frm" action="agrEncy!add.action" method="post" theme="simple" id="frm">
	...
	<table width="100%" class="tableStyle" transmode="true">
		...
		<tr>
			<td >父级菜单：</td>		
			<td>
          	<select id="supiorId" name="ency.parentId" >
		...
		<tr>
           	<td>状态：</td>
           	<td><select id="state" name="ency.state" >
		...
		<tr>
            <td>是否首页显示：</td>
            <td><select id="isMenu" name="ency.isHome">
