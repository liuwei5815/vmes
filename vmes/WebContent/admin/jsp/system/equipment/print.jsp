				...
				<table style="font-size: 20px; margin-top: 40px;">
					<tr>
						<td rowspan="4" style="width: 160px; height: 160px;"><img
							src="/qrcode/${cell[0].equipmentqrCode }.png" style="width: 160px;" /></td>
						<td class="left">系统设备编号:${cell[0].equipmentCode }</td>

					</tr>
					<tr>
						<td class="left">设备名称:${cell[0].equipmentName }</td>

					</tr>
					<tr>
						<td class="left">规格/型号:${cell[0].equipmentModel }</td>

					</tr>
					<tr>
						<td class="left">所属部门:${cell[1].name }</td>
