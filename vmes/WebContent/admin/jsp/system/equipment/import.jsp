...
<body>
<div class="padding5">
<form action="${ctx}/admin/equipment!importEquipment.action" name="form1" method="post" id="frm" style="margin: 0" enctype="multipart/form-data">
	...
	<table >
        ...
        <tr>
            <td colspan="4" align="left">
	       	<span class="blue">
	       		说明:<br>
	       		1.<a href="${ctx }/excels/Equipmenttemplet.xls" style="color:red">点击此处下载模板;</a><br>
