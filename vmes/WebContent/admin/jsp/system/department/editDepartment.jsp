...
<div style="padding: 0 20px 0 20px;">
	<s:form action="admin/departmentAction!editDepartment.action" method="post" theme="simple" id="frm">
	...
	<tr class="validate">
		<td>部门名称：</td>
		<td>
			<input type="text" name="department.name"  value="${department.name }" class="validate[required,maxSize[15]]" data-prompt-position="centerRight:-20"/>
