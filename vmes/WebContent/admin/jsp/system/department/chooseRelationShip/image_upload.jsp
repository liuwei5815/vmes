...
<form id="uploadForm" action="${ctxAdmin }/departmentAction!uploadImage.action" method="post" enctype="multipart/form-data" target="hiddenIframe" style="width:0px;height:0px;">
