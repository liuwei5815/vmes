...
<div class="padding5">
	...
	<form id="frm" method="post" target="querytable" action="admin/departmentAction!queryProvince.action">
...
<div id="winScrollContent">
	...
	src="${ctx}/admin/departmentAction!queryProvince.action?Parentid=${Parentid}"
