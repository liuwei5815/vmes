...
<input type="hidden" name="aaa" id="aaa" value="123" />
...
<table class="tableStyle" id="checkboxTable">
	...
	<s:iterator value="list" status="st" var="cell">
		 <tr>
		 	<td><input type="checkbox" productCode=${cell.productCode } typespec=${cell.typespec }  lable="${cell.name }"  value="${cell.id }"  name="checks" /></td>
			<td>${st.index+1 }</td>
