...
<div class="static_box1">
	...
	<div class="box1_middleright2">
		<s:form action="admin/produceplanAction!editNoOrderNum.action" method="post" theme="simple" id="frm">
      		...
      		<fieldset>
    			...
    			<table width="100%" class="tableStyle" transmode="true">
					<tr>
						<td>生产计划数：</td>
						<td>
							<input type="text" name="produceplan.num" id="produceplanNum" class="validate[required,custom[onlyNumber],length[0,6]] " value="${produceplan.num }" class="textinput default hid" ></input>
