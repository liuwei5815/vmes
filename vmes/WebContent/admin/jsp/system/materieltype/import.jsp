...
<script>
	...
	**/
	function impContract(){
		...
		showProgressBar("正在导入物料类型，请勿进行其他操作")
		$("#frm").submit();
...
<body>
<div class="padding5">
<form action="${ctx}/admin/materielType!importMaterialType.action" name="form1" method="post" id="frm" style="margin: 0" enctype="multipart/form-data">
	...
	<table >
        ...
        <tr>
            <td colspan="4" align="left">
	       	<span class="blue">
	       		说明:<br>
	       		1.<a href="${ctx }/excels/MaterielTypeTemplet.xls" style="color:red">点击此处下载模板;</a><br>
	       		2.请先将Excel模板中示例信息删除;<br>
	       		3.按示例填写要导入的物料类型信息;<br>
