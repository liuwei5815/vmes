...
<div style="padding: 0 20px 0 20px;">
	<s:form action="admin/materielType!add.action" method="post" theme="simple" id="frm">
	...
	<input type="hidden" name="successflag" id="successflag" value="${successflag}" /> 
	 <table width="100%" class="tableStyle" transmode="true">
		<tr class="validate">
			<td>物料类型名称：</td>
			<td>
				<input type="text"name="materialType.name" value="" lable="物料类型名称" dataType="2" class="validate[required,length[0,15]]" />
		 ...
		 <tr  style="border: medium none; background-color: transparent;" yzid="2">
				<td style="text-align: right; padding-top: 3px; padding-bottom: 3px; border: medium none;">所属物料类型：</td>
					<td style="padding-top: 3px; padding-bottom: 3px; border: medium none;">
						...
						<input id="Type_1" name="materialType.pid" type="hidden" value="0"></div>
