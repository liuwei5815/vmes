...
function del(id){
	...
	top.Dialog.confirm("确定要删除这个表吗？",function(){
		$.ajax({
		     type: "POST",
		     url: "${ctx}/admin/sys_tables!delTableById.action",
		     cache: false,
		     dataType:"json",
		     data:{"tables.id":id},
...
<table class="tableStyle" id="checkboxTable">
	...
	<s:iterator value="list" status="st" var="cell">
		<tr>
			...
			<td>
		       <input type="checkbox" id="<s:property value="id"/>" <s:if test="#cell.menuId!=null">checked="checked"</s:if> name="checks" onclick="createMenu(this)"/>
			</td>
			<td width="100">
