...
<div style="">
	...
	<s:form action="admin/config!add.action" method="post" theme="simple" id="frm">
	<table width="100%" class="tableStyle" transmode="true">
			<tr class="validate">
				<td>配置值：</td>
				<td>
					<input type="text" id="confname" name="config.confname" />
				</td>
			</tr>
			<tr class="validate">
				<td>配置名：</td>
				<td>
					<input type="text" id="confvalue" name="config.confvalue" />
				</td>
			</tr>
			<tr class="validate">
				<td>描述：</td>
				<td>
					<input type="text" id="des" name="config.des" />
				</td>
			</tr>
		<tr>
			<td colspan="2">&nbsp;</td>
