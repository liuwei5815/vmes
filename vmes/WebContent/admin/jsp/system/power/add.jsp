...
<div class="box1_middlecenter"><div class="box1_middleleft2"><div class="box1_middleright2">
	...
	<input type="hidden" name="successflag" id="successflag" value="${successflag}"/>
	  <table class="tableStyle" transmode="true">
		...
		<tr>
			<td>账&nbsp;&nbsp;号：<span class="star">*</span></td><td><input type="text" id="name" name="admin.account" class="validate[required,length[0,15]]"  style="width:200px;"/></td>
		</tr>
		<tr>
		...
		<tr>
			<td>确认密码：<span class="star">*</span></td><td><input type="password" id="RePassword" name="RePassword" checkStrength="true" class="validate[required,length[3,15]]"  style="width:200px;"/></td>
		</tr>
		<tr>
