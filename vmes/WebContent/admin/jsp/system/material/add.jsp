...
<div style="padding: 0 20px 0 20px;">
	...
	<s:form action="admin/material!add.action" method="post" theme="simple" id="frm">
	...
	<tr class="validate">
		<td>用户物料编号：</td>
		<td>
			<input type="text" name="material.usermaterialCode" class="validate[length[0,15]]" />
		</td>
	</tr>
	<tr class="validate">
		<td>物料名称：</td>
		<td>
			<input type="text" name="material.materialName" class="validate[required,length[0,15]]"/>
	...
	<tr class="validate">
		<td>规格/型号：</td>
		<td>
			<input type="text" name="material.materialSpec" class="validate[required,length[0,15]]"/>
			<span class="star"> *</span>
		</td>
	</tr>
	<tr  style="border: medium none; background-color: transparent;" yzid="2">
		<td style="text-align: right; padding-top: 3px; padding-bottom: 3px; border: medium none;">物料类型：</td>
			<td style="padding-top: 3px; padding-bottom: 3px; border: medium none;">
				<div style="float: left;"><input class="textinput simple" value="" id="type_lable" readonly="readonly" type="text">
				<input id="type" targetid="84" name="material.materialType" value="" not-null="1" lable="物料类型" datatype="1" type="hidden"></div>
	...
	<tr class="validate">
		<td>计量单位：</td>
		<td>
			<input type="text" name="material.materialUnit" class="validate[required,length[0,6]]" data-prompt-position="centerRight:-20" />
			<span class="star"> *</span>
		</td>
	</tr>
	<tr>
