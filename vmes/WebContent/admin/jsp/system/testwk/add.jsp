...
<div style="">
	...
	<s:form action="admin/testwk!add.action" method="post" theme="simple" id="frm">
	<table width="100%" class="tableStyle" transmode="true">
			<tr class="validate">
				<td>编码：</td>
				<td>
					<input type="text" id="number" name="test_wk.number" />
				</td>
			</tr>
			<tr class="validate">
				<td>名称：</td>
				<td>
					<input type="text" id="name" name="test_wk.name" />
				</td>
			</tr>
			<tr class="validate">
				<td>状态：</td>
				<td>
					<input type="text" id="state" name="test_wk.state" />
				</td>
			</tr>
		<tr>
			<td colspan="2">&nbsp;</td>
