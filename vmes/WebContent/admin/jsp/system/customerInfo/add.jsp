...
function unload(){
    if(document.frm.successflag.value == "1"){//执行成功
    	...
    	this.parent.frmright.window.location.href="${ctx}/admin/customerInfo!init.action";	
	}else{
...
<div style="padding: 0 20px 0 20px;">
	...
	<s:form action="admin/customerInfo!add.action" method="post" theme="simple" id="frm">
	...
	<table width="100%" class="tableStyle" transmode="true" style="height: 200px">
	<tr>
		<td>系统用户号：</td>
		<td>
