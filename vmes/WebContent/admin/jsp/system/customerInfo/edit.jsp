...
<div style="padding: 0 20px 0 20px;">
	...
	<s:form action="admin/customerInfo!edit.action" method="post" theme="simple" id="frm">
	...
	<tr class="validate">
		<td>系统用户号：</td>
		<td>
			<input type="text" name="customer.name" value="${customer.name}" class="validate[required,length[0,15]]" />
	...
	<tr class="validate">
		<td>客户名称：</td>
		<td>
			<input type="text" name="customer.tel" value="${customer.tel}" class="validate[custom[mobilephone]]" />
		</td>
	</tr>
	<tr class="validate" >
