...
function chooseUnit(showDomId,no){
	...
	diag.ID="choose";
	diag.Title = "选择产品单位";
	diag.URL = "${ctx}/admin/product!queryUints.action";
	diag.Height=500;
	diag.Width=300;
...
<div style="padding: 0 20px 0 20px;">
	<s:form action="admin/product!addUnit.action" method="post" theme="simple" id="frm">
	...
	<input type="hidden" name="department.pid" value="${pid }" />
	 <table width="100%" class="tableStyle" transmode="true">
		<tr class="validate">
			<td>单位名称：</td>
			<td>
				<input type="text"name="pu.name" value="" lable="产品单位类型" dataType="2"class="validate[required,length[0,15]]" />
		 ...
		 <tr  style="border: medium none; background-color: transparent;" yzid="2">
				<td style="text-align: right; padding-top: 3px; padding-bottom: 3px; border: medium none;">所属单位类型：</td>
					<td style="padding-top: 3px; padding-bottom: 3px; border: medium none;">
						...
						<input id="Type_1" name="pu.pid" type="hidden"></div>
