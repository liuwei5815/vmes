...
<script>
	...
	function unload(){
	    ...
	    if($("#successflag").val() == "1"){//执行成功
	    	top.Dialog.alert("批量导入成功",function(){
	...
	**/
	function impContract(){
		...
		showProgressBar("正在导入设备类型，请勿进行其他操作")
		$("#frm").submit();
...
<body>
<div class="padding5">
<form action="${ctx}/admin/equipmentType!importEquipmentType.action" name="form1" method="post" id="frm" style="margin: 0" enctype="multipart/form-data">
	...
	<table >
        ...
        <tr>
            <td colspan="4" align="left">
	       	<span class="blue">
	       		说明:<br>
	       		1.<a href="${ctx }/excels/EquipmentTypeTemplet.xls" style="color:red">点击此处下载模板;</a><br>
	       		2.请先将Excel模板中示例信息删除;<br>
	       		3.按示例填写要导入的设备类型信息;<br>
