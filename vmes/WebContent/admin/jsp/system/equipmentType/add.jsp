...
<div style="padding: 0 20px 0 20px;">
	<s:form action="admin/equipmentType!add.action" method="post" theme="simple" id="frm">
	...
	<input type="hidden" name="successflag" id="successflag" value="${successflag}" /> 
	 <table width="100%" class="tableStyle" transmode="true">
		<tr class="validate">
			<td>设备类型名称：</td>
			<td>
				<input type="text" name="equipmentType.type" value="" lable="设备类型名称" dataType="2" class="validate[required,length[0,15]]" />
		 ...
		 <tr  style="border: medium none; background-color: transparent;" yzid="2">
				<td style="text-align: right; padding-top: 3px; padding-bottom: 3px; border: medium none;">所属设备类型：</td>
					<td style="padding-top: 3px; padding-bottom: 3px; border: medium none;">
						...
						<input id="Type_1" name="equipmentType.pid" type="hidden" value="0"></div>
